...
class AsyncPlansResource:
    ...
    async def remove_feature(self, id: str, feature_id: str) -> RemovedPlanFeature:
        """Detach a feature from a plan."""
        return _parse_data(
            await self._http.delete(f"/plans/{id}/features/{feature_id}"), RemovedPlanFeature
        )
    ...
    async def add_feature(
        ...
        *,
        ...
        return _parse_data(
            await self._http.post(f"/plans/{id}/features", body, idempotency_key=idempotency_key),
            PlanFeature,
        )
    ...
    async def delete_regional_prices(self, id: str, price_id: str) -> DeletedPlanRegionalPricing:
        ...
        return _parse_data(
            await self._http.delete(f"/plans/{id}/prices/{price_id}/regional"),
            DeletedPlanRegionalPricing,
        )
    ...
    async def delete_price(self, id: str, price_id: str) -> DeletedObject:
        """Archive a price for new subscriptions. Existing subscriptions that selected it continue using its current catalog value."""
        return _parse_data(await self._http.delete(f"/plans/{id}/prices/{price_id}"), DeletedObject)
    ...
    async def add_price(
        ...
        *,
        ...
        return _parse_data(
            await self._http.post(f"/plans/{id}/prices", body, idempotency_key=idempotency_key),
            PlanPrice,
        )
    ...
    async def set_regional_pricing(
        ...
        *,
        ...
        return _parse_data(
            await self._http.put(f"/plans/{id}/regional", body, idempotency_key=idempotency_key),
            PlanRegionalPricingResult,
        )

    async def get(self, id: str) -> Plan:
        """Get a plan with public price IDs and their automatic introductory offer IDs."""
        return _parse_data(await self._http.get(f"/plans/{id}"), Plan)
    ...
    async def update(
        ...
        *,
        ...
        return _parse_data(
            await self._http.patch(f"/plans/{id}", body, idempotency_key=idempotency_key), Plan
        )

    async def delete(self, id: str) -> DeletedObject:
        """Soft-delete a plan."""
        return _parse_data(await self._http.delete(f"/plans/{id}"), DeletedObject)
    ...
    async def set_visibility(
        ...
        return _parse_data(
            await self._http.put(f"/plans/{id}/visibility", body, idempotency_key=idempotency_key),
            Plan,
        )

    async def list(self, *, include_private: bool | None = None) -> PlansListResult:
        ...
        return _parse_data(await self._http.get("/plans", query), PlansListResult)
    ...
    async def create(
        ...
        *,
        ...
        return _parse_data(
            await self._http.post("/plans", body, idempotency_key=idempotency_key), Plan
        )
