        ...
        *,
        ...
        return _parse_data(
            await self._http.put(
                f"/subscriptions/{id}/offer", body, idempotency_key=idempotency_key
            ),
            Subscription,
        )

    async def remove_offer(self, id: str) -> Subscription:
        ...
        return _parse_data(await self._http.delete(f"/subscriptions/{id}/offer"), Subscription)
