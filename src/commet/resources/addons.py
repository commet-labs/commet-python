...
class AddonsResource:
    ...
    def list(
        ...
        return _parse_list(self._http.get("/addons", query), Addon)

    def get(self, id: str) -> ApiResponse[Addon]:
        """Retrieve an add-on by its public ID or slug."""
        return _parse(self._http.get(f"/addons/{id}"), Addon)
    ...
    def create(
        ...
        *,
        ...
        return _parse(self._http.post("/addons", body, idempotency_key=idempotency_key), Addon)
    ...
    def update(
        ...
        *,
        ...
        return _parse(self._http.put(f"/addons/{id}", body, idempotency_key=idempotency_key), Addon)

    def delete(self, id: str) -> ApiResponse[DeletedObject]:
        """Soft-delete an add-on. Fails if the add-on has active subscriptions."""
        return _parse(self._http.delete(f"/addons/{id}"), DeletedObject)
