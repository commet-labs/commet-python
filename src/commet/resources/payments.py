...
class PaymentsResource:
    ...
    def cancel(self, id: str, *, idempotency_key: str | None = None) -> Payment:
    ...
    def get(self, id: str) -> Payment:
        ...
        return _parse_data(self._http.get(f"/payments/{id}"), Payment)
    ...
    def list(
        ...
        return _parse_data(self._http.get("/payments", query), PaymentsListResult)
    ...
    def create(
        ...
        *,
        ...
        return _parse_data(
            self._http.post("/payments", body, idempotency_key=idempotency_key), Payment
        )
