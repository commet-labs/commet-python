...
class PaymentsResource:
    ...
    def list(
        ...
        return _parse_list(self._http.get("/payments", query), Payment)
    ...
    def create(
        ...
        *,
        ...
        return _parse(self._http.post("/payments", body, idempotency_key=idempotency_key), Payment)
    ...
    def charge(
        ...
        *,
        ...
        return _parse(
            self._http.post("/payments/charge", body, idempotency_key=idempotency_key), Payment
        )

    def get(self, id: str) -> ApiResponse[Payment]:
        """Retrieve a payment by its public ID."""
        return _parse(self._http.get(f"/payments/{id}"), Payment)

    def cancel(self, id: str, *, idempotency_key: str | None = None) -> ApiResponse[Payment]:
        ...
        return _parse(
            self._http.post(f"/payments/{id}/cancel", idempotency_key=idempotency_key), Payment
        )
