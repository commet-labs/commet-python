...
class PromoCodesResource:
    ...
    def list(
        ...
        *,
        ...
        return parse_promo_code_list(
            self._http.get("/promo-codes", build_body(limit=limit, cursor=cursor))
        )

    def get(self, promo_code_id: str) -> ApiResponse[PromoCodeDetail]:
        return parse_promo_code_detail(self._http.get(f"/promo-codes/{promo_code_id}"))
    ...
    def create(
        ...
        *,
        ...
        return parse_promo_code(self._http.post(
            "/promo-codes",
            build_body(
    ...
    def update(
        ...
        *,
        ...
        return parse_promo_code_detail(self._http.put(
