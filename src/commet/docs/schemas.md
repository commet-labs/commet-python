...
- `currency` (`Literal["usd", "ars", "brl", "clp", "cop", "pen", "uyu", "pyg", "bob", "mxn", "cad", "eur", "jpy", "cny", "krw", "hkd", "sgd", "twd", "inr", "thb"]`, required) — Presentment currency configured for this plan and market.
