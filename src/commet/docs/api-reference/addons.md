...
- `name` + `base_price` + `feature_id` + `consumption_model`
- `name` + `base_price` + `feature_id` + `consumption_model` + `included_units` + `overage_rate`
- `name` + `base_price` + `feature_id` + `consumption_model` + `credit_cost`
- `name` + `base_price` + `feature_id` + `consumption_model` + `overage_rate`
